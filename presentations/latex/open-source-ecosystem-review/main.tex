...
\newcommand{\stage}[4]{\node[rounded corners=8pt,fill=#2,draw=#3,thick,minimum width=2.75cm,minimum height=1.0cm,align=center] (#1) {#4};}
...
\begin{frame}{1. O problema: abrir não é publicar}
  ...
  \begin{tikzpicture}[node distance=0.42cm]
    ...
    \stage{people}{softblue}{utfprblue}{pessoas}
...
\begin{frame}{2. Abertura é multidimensional}
  ...
  \begin{tikzpicture}[node distance=0.38cm]
    ...
    \stage{s2}{softyellow}{utfpryellow}{organizacional}
    \stage{s3}{softred}{muted}{jurídica}
    \stage{s4}{softgreen}{utfprteal}{social}
  \end{tikzpicture}
  \end{center}
  \vspace{0.45cm}
...
\begin{frame}{10. BULB: depois de abrir, medir}
  ...
  \begin{tikzpicture}[node distance=0.36cm]
    ...
    \stage{b}{softgray}{muted}{bugs e pedidos}
    \stage{c}{softyellow}{utfpryellow}{comunicação}
    \stage{x}{softgreen}{utfprteal}{contribuições}
  \end{tikzpicture}
  \end{center}
  \vspace{0.56cm}
  \begin{center}
